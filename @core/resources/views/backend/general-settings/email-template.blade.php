                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.general.email.template')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">@username Will be replaced by username of user and @company will be replaced by site title also @message will be replced dynamically with message.</small>
                            </div>
